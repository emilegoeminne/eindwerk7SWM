        ...
        <div class="container-fluid">
            <div class="container">
                <div class="alert alert-light" role="alert">
                    <strong>Vul dit in zodat we het product kunnen opsturen!</strong>
                </div>
                <h2>Verzend Info</h2>
                    ...
                    <div class="row">
                        <div class="col col-50">
                            <div class="form-group col">
                                ...
                                <label for="inputStreet" class="col-sm col-form-label">Straat + NR : </label>
                                <div class="col-sm">
                                    <input type="text" name="inputStreet" class="form-control" id="inputStreet" placeholder="Steenbrugstraat 5">
                                </div>
                            </div>
                        </div>
                        <div class="col col-50">
                            <div class="col col-50">
                                <div class="form-group col">
                                    <label for="inputCity" class="col-sm col-form-label">Stad : </label>
                                    <div class="col-sm">
                                        <input type="text" class="form-control" name="inputCity" id="inputCity" placeholder="Harelbeke">
                                    </div>
                                </div>
                            </div>
                            <div class="col col-50">
                                <div class="form-group col">
                                    <label for="inputPostcode" class="col-sm col-form-label">Postcode : </label>
                                    <div class="col-sm">
                                        <input type="number" name="inputPostcode" class="form-control" id="inputPostcode" placeholder="8530">
                                    </div>
